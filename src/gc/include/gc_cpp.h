...
inline void* operator new( 
 ...
 inline void *operator new[]( size_t size )
 {
   ...
   if ( GC_VERBOSE > GC_VERBOSE_VALUE ) {
     printf("GC --- gc_cpp.h:operator new[] (%ld)\n\r", size ); fflush(stdout);
   }
#endif
...
#ifdef GC_VERBOSE_GLOBAL
  if ( GC_VERBOSE > GC_VERBOSE_VALUE ) {
    printf("GC --- gc_cpp.h:operator new (%d)\n\r", size ); fflush(stdout);
  }
#endif
...
#ifdef GC_VERBOSE_GLOBAL
   if ( GC_VERBOSE > GC_VERBOSE_VALUE ) {
     printf("GC --- gc_cpp.h:operator new (%d, %d)\n\r", size, gcp ); fflush(stdout);
   }
#endif
...
#ifdef GC_VERBOSE_GLOBAL
   if ( GC_VERBOSE > GC_VERBOSE_VALUE ) {
     printf("GC --- gc_cpp.h:operator delete (%x)\n\r", (int)obj ); fflush(stdout);
   }
#endif
   GC_FREE( obj );
}
...
#ifdef GC_VERBOSE_GLOBAL
  if ( GC_VERBOSE > GC_VERBOSE_VALUE ) {
    printf("GC --- gc_cpp.h:operator new (%d, %d, %x, %x)\n\r", 
	   size, gcp, (int)cleanup, (int)clientData ); fflush(stdout);
  }
#endif
