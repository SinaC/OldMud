...
register int k;
{
    ...
    if ( GC_VERBOSE > GC_VERBOSE_VALUE+1 ) {
      int DEBUG_BYTES = 2*sizeof(word);
      switch( k ) {
      case STUBBORN: printf("STUBBORN %d [%d]\n\r", lb, DEBUG_BYTES ); break;
      case PTRFREE: printf("PTRFREE %d [%d]\n\r", lb, DEBUG_BYTES ); break;
      case NORMAL: printf("NORMAL %d [%d]\n\r", lb, DEBUG_BYTES ); break;
      case UNCOLLECTABLE: printf("UNCOLLECTABLE %d [%d]\n\r", lb, DEBUG_BYTES ); break;
      case AUNCOLLECTABLE: printf("AUNCOLLECTABLE %d [%d]\n\r", lb, DEBUG_BYTES ); break;
      default: printf("UNKNOWN %d [%d]\n\r", lb, DEBUG_BYTES );
      }
      fflush(stdout);
    }
#endif
...
DCL_LOCK_STATE;
  ...
  if ( GC_VERBOSE > GC_VERBOSE_VALUE )
    printf("GC --- malloc.c: GC_malloc_atomic (%d)\n\r", lb );
#endif
...
#ifdef GC_VERBOSE_GLOBAL
  if ( GC_VERBOSE > GC_VERBOSE_VALUE )
    printf("GC --- malloc.c: GC_malloc (%d)\n\r", lb );
#endif
