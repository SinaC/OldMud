...
// SinaC 2003
// Comment following define if you want better performance and no spam
#define GC_VERBOSE_GLOBAL
extern int GC_VERBOSE; // defined in malloc.c, used in dbg_mlc.c, malloc.c, gc_cpp.cc
#define GC_VERBOSE_VALUE (5)
